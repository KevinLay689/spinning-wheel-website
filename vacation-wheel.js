class SimpleSpinner {
    constructor() {
        ...
        this.segments = ['YES ✈️', 'NO 🏠'];
        this.colors = ['#00CED1', '#FF8C00'];
    ...
    showModal(result) {
        ...
        if (result.includes('YES')) {
            this.modalLogo.innerHTML = '✈️';
            this.modalLogo.style.fontSize = '60px';
            this.modalMessage.textContent = 'Pack your bags! Adventure awaits! 🌴🏝️';
        } else {
            this.modalLogo.innerHTML = '🏠';
            this.modalLogo.style.fontSize = '60px';
            this.modalMessage.textContent = 'Staycation it is! Netflix and chill? 🍿';
        }
